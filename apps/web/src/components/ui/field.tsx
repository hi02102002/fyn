...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: <improve accessibility>
		<div
			role="group"
			data-slot="field"
...
function FieldError({
	...
	const content = useMemo(() => {
		...
		const _errors = errors.reverse().slice(0, 1);
		...
		return (
			<ul className="ml-4 flex list-disc flex-col gap-1">
				{errors
					...
					.map(
						(error, index) =>
							// biome-ignore lint/suspicious/noArrayIndexKey: <i>mplementing a list with dynamic items</i>
